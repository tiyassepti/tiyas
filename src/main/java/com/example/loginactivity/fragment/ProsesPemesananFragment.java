...
import com.example.loginactivity.admin.DetailpemesananActivity;
 ...
 */
public class ProsesPemesananFragment extends Fragment implements PemesananAdapter.PemesananAdapterOnClick  {
    ...
    public ProsesPemesananFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view= inflater.inflate(R.layout.fragment_proses_pemesanan, container, false);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    Adapter = new PemesananAdapter( ProsesPemesananFragment.this,userMakananList, idKeyList);
