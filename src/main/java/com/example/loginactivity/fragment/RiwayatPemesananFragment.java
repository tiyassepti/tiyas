...
import com.example.loginactivity.user.RiwayatPinjamanActivity;
...
public class RiwayatPemesananFragment extends Fragment implements PemesananAdapter.PemesananAdapterOnClick  {
    private static final String TAG = "PemesananDiprosesFrag";
    ...
    public RiwayatPemesananFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_riwayat_pemesanan, container, false);
        dialog = new ProgressDialog(getActivity());
        dialog.setMessage("Loading...");
        dialog.show();

        Log.d(TAG, "onCreateView: Fragment Coy");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    Adapter = new PemesananAdapter( RiwayatPemesananFragment.this,userMakananList, idKeyList);
