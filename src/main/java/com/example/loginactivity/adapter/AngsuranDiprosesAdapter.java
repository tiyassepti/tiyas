...
public class AngsuranDiprosesAdapter extends RecyclerView.Adapter<AngsuranDiprosesAdapter.ViewHolder>{

    View mView;

    List<Angsuran> angsuranList;
    private AngsuranDiprosesAdapter.SedangDiprosesAdapterOnClick listener;

    public interface SedangDiprosesAdapterOnClick{
        void angsuranClicked(View v, int position, String mode, String idAngsuran, String idPinjam, String mail);
    }
    long sisaPinjaman;
    String nama;

    public AngsuranDiprosesAdapter(List<Angsuran> angsuranList, SedangDiprosesAdapterOnClick listener, long sisaPinjaman, String nama) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        holder.cv_nama.setText(String.valueOf(nama));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cv_nama = itemView.findViewById(R.id.cv_ang_nama);
